...
//#include "secrets.h"
    ...
    const char MQTT_PUB_TOPIC[] = "channel1/data1";

    #ifdef CHECK_CA_ROOT
    static const char digicert[] PROGMEM = SERVER_CRT;
    #endif
  ...
  // Extracted by: openssl x509 -fingerprint -in ca.crt
    static const char fp[] PROGMEM = "AA:BB:CC:DD:EE:FF:A:BB:CC:DD";
    #endif
#endif
